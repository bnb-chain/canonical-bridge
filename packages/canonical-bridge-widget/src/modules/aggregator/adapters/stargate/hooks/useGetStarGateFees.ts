      ...
      try {
        ...
        if (quoteOFTResponse[0]) {
          setAllowedSendAmount({
            min: formatNumber(
              Number(formatUnits(quoteOFTResponse[0].minAmountLD, selectedToken?.decimals || 18)),
              8,
            ),
            max: formatNumber(
              Number(formatUnits(quoteOFTResponse[0].maxAmountLD, selectedToken?.decimals || 18)),
              8,
            ),
          });
        }
