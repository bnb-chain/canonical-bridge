...
import { CLIENT_TIME_OUT, VALIDATION_API_TIMEOUT } from '@/constants';
...
import { POOL_TRANSFER_BRIDGE } from '@/adapters/cBridge/abi/poolTransferBridge';
import { ORIGINAL_TOKEN_VAULT } from '@/adapters/cBridge/abi/originalTokenVault';
import { ORIGINAL_TOKEN_VAULT_V2 } from '@/adapters/cBridge/abi/originalTokenVaultV2';
import { PEGGED_TOKEN_BRIDGE } from '@/adapters/cBridge/abi/peggedTokenBridge';
import { PEGGED_TOKEN_BRIDGE_V2 } from '@/adapters/cBridge/abi/peggedTokenBridgeV2';
import { isEvmAddress } from '@/shared/address';

export function cBridgeConfig(
  options: IBaseBridgeConfigOptions
): IBaseBridgeConfig {
  return {
    bridgeType: 'cBridge',
