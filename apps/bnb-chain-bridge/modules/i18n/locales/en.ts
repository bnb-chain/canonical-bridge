export const en = {
  'seo.title': 'Bridges | Cross-Chain Transfer - BNB Chain',
  'seo.description':
    'BNB Chain Bridges provides a list of bridges for you to transfer assets between networks (Ethereum, Polygon and etc.) and BNB Chain blockchain ecosystem.',
