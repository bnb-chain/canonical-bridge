...
import stargateConfig from '@/server/data/stargate/config.json';
import layerZeroConfig from '@/server/data/layerZero/config.json';
import { cacheInfo } from '@/server/data/cache';

export function getTransferConfig() {
  const cBridgeConfig = cacheInfo.data.cBridgeConfig;
  const deBridgeConfig = cacheInfo.data.deBridgeConfig;
